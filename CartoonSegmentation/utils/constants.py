...
models_path = folder_paths.folder_names_and_paths['cartoon_segmentation']['anime_instance_path']

DEFAULT_DETECTOR_CKPT = f'{models_path}/rtmdetl_e60.ckpt'
DEFAULT_DEPTHREFINE_CKPT = f'{models_path}/kenburns_depth_refinenet.ckpt'
DEFAULT_INPAINTNET_CKPT = f'{models_path}/kenburns_inpaintnet.ckpt'
DEPTH_ZOE_CKPT = f'{models_path}/ZoeD_M12_N.pt'
