...
if sys.platform == 'linux':
    PMLIB = ctypes.CDLL('custom_nodes/ComfyUI_CartoonSegmentation/CartoonSegmentation/animeinsseg/data/libs/libpatchmatch_inpaint.so')
else:
    PMLIB = ctypes.CDLL('custom_nodes/ComfyUI_CartoonSegmentation/CartoonSegmentation/animeinsseg/data/libs//libpatchmatch.dll')
