...
from custom_nodes.ComfyUI_CartoonSegmentation.CartoonSegmentation.utils.constants import DEFAULT_DEVICE
...
def load_refinenet(refine_method = 'animeseg', device: str = None) -> AnimeSegmentation:
    ...
    if refine_method == 'animeseg':
        ...
        sd = torch.load(f"{folder_paths.folder_names_and_paths['cartoon_segmentation']['anime_instance_path']}/"
                        f"refine_last.ckpt", map_location='cpu')
